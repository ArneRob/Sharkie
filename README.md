...
You control Sharkie, an underwater shark navigating through the ocean. Collect coins and poison bottles, defeat jellyfish enemies, and face a final boss to win.

- **Slap** nearby enemies with `Space`
- **Throw** poison bubbles with `F`
- **Move** with Arrow keys or WASD
- **Collect** coins and poison bottles by swimming through them
...
- Two enemy types (jellyfish + flashing variant) plus end boss
