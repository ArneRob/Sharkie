...
function returnIMAGES_MAKE_BUBBLE() {
    return IMAGES_MAKE_BUBBLE = [
...
function returnIMAGES_IDLE_LONG() {
    return IMAGES_IDLE_LONG = [
...
function returnIMAGES_IDLE_SLEEP() {
    return IMAGES_IDLE_SLEEP = [
        '../img/1.Sharkie/2.Long_IDLE/I11.png',
        '../img/1.Sharkie/2.Long_IDLE/I12.png',
        '../img/1.Sharkie/2.Long_IDLE/I13.png',
        '../img/1.Sharkie/2.Long_IDLE/I14.png',
...
function returnIMAGES_Endboss_SWIMMING() {
    return [
...
function returnIMAGES_Endboss_FIGHT() {
    return [
...
function returnIMAGES_Endboss_INTRO() {
    return [
...
function returnIMAGES_Endboss_DEAD() {
    return [
